...
- ⚠️ **NFR2 KHÔNG được story này chấm.** Một lượt đổi con trỏ trên 9.850 câu đo được **706–770 ms** *(trần 50 ms)*, và Story 2.11 thêm một đường **nạp lại toàn bộ lưới** vào cùng bề mặt đó. Story này **không đo và không vá** — nó không chạm một dòng nào của đường render. **Chủ vẫn là Story 2.4**, đúng như §Ranh giới phạm vi của story ghi.
