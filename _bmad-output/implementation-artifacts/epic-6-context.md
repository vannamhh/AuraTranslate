...
- Bộ lọc "cần xem" áp cho mọi đường nhập — điều kiện để dò bảng mã/bóc nội dung/luật làm sạch còn tác dụng ở quy mô hàng chục Chương. Hai con số đầu màn (`N Chương cần xem`/`M Chương sạch`) gom bốn nguyên nhân: bảng mã tin cậy thấp (cờ cấp **lượt nhập**, không lẫn vào từng Chương — gắn cờ cả N sẽ làm bộ lọc mất tác dụng), bóc ra ngắn bất thường so với trung vị các Chương khác, luật làm sạch xoá quá nhiều (cùng phép so trung vị, không hằng số cố định), và link hỏng. `⌥W` lọc về nhóm cần xem; `⌘↵` xác nhận toàn bộ dùng hợp âm `Mod+Alt+Enter` (né trùng lệnh xác nhận segment của Epic 2) — hợp âm cuối cùng là nợ sản phẩm, chủ Ice.
