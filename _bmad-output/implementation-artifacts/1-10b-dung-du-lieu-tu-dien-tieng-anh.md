...
- [x] **Task 8 — Test** (AC1, AC2, AC3, AC4, AC8)
  ...
  - [x] ⛔ **`src-tauri/tests/` ⛔ không thêm và ⛔ không sửa một dòng nào. 62 test phải ra đúng 62.**
...
| **Cổng `DictionarySource`** | ❌ **Không** — **1.13**. ⛔ `ports/mod.rs` giữ nguyên |
...
| `SCHEMA_VERSION` / `PRAGMA user_version` | **1** — ⛔ giữ nguyên |
...
**Luật:** đổi **số** và **danh sách mã**, ⛔ **giữ nguyên doc-comment nói về lớp gỡ rời**. ⛔ Không xoá test. ⛔ Không đổi `base_and_detachable_code_sets_are_disjoint`.
...
### 🟢 PHÁN QUYẾT NFR6: **ĐẠT** — với **BẢY** nguồn *(6 nền + 2 gỡ rời − ⛔ thiếu HVTĐTD và Cổ hán văn)*
