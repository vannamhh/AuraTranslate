...
- command pha không có trong feature mặc định, không thêm dependency, không mở mạng; nó chỉ
  ...
  `$HOME/.auratranslate-nfr-bench-phase` do runner tạo **trong HOME nháp** và native-eval các kiểm
  DOM/tab. WebKit
...
- fixture export chỉ nhận đích có marker `auratranslate-nfr-bench-` và thư mục rỗng;
