...
- **Q4** — Hiệu chỉnh ba ngưỡng tạm A6, A7, A8. Đóng bằng đo trên thư viện thật ở Giai đoạn 3. **VẪN MỞ.** Story 5.14 (2026-09-02) đã cấp số **sơ bộ** cho cả ba trên một fixture **tổng hợp** — A6 dưới ngưỡng, A7 và A8 vượt — nhưng số sơ bộ không hiệu chỉnh được ngưỡng nào: điều kiện đóng là đo trên thư viện 5.000 Chương tạo **qua sản phẩm** (FR14), và đó là **Story 6.18**. Không ngưỡng nào được sửa theo số của 5.14. *Chủ: chủ dự án.*
